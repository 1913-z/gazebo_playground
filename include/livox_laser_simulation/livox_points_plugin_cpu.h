...
#define GZ_REGISTER_STATIC_SENSOR_PLUGIN_CPP(LivoxPointsPlugin)
...
class GAZEBO_VISIBLE LivoxPointsPlugin : public RayPlugin{
 public:
    LivoxPointsPlugin();
 ...
 protected:
    virtual void OnNewLaserScans() override;
